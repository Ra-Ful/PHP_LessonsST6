...
<script>
  function Ajax_Request(cmd, data_in, param) {
    ...
    fetch('ajax_03.php', {
      ...
      .then(data_out => {
        ...
        if (cmd == 'item_checked') {
          item_checked(data_out, param);
        }
        if (cmd == 'item_remove') {
          item_remove(data_out, param);
        }
      });
  }

  function item_checked(data, item) {
  ...
  function item_remove(data, item) {
  ...
  todoListItem.addEventListener("change", function(event) {
    ...
    Ajax_Request('item_checked', data, item);
  ...
  todoListItem.addEventListener("click", function(event) {
    ...
    if (item.classList.contains('remove')) {
      ...
      Ajax_Request('item_remove', data, item);
    }
